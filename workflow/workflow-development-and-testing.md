...
- Use prompt templates from your prompt library - [prompt-new-feature](prompt-new-feature.md)
...
- Prompt the AI to update or create relevant documentation in the repository’s architecture folder, including regular updates to the data models, implementation specifics and general architecture. Use the [prompt-update-documentation](prompt-update-documentation.md) prompt for this purpose.
