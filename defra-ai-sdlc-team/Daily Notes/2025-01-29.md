...
- Keep the tone concise, understated and professional.
- use British English.
...
Prompt:
```
Look at all the files in the @workflow folder, review all the content in the .md files as per the instructions in the @.cursorrules file and make improvements as instructed.
```