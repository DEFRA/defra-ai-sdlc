...
2. **Rules for AI**: Set up project [Rules for AI](../Resources-Tools/rules-for-ai) for consistent and repeatable standards, patterns and conventions across your codebase
...
- Use the three prompts in [prompt-test-driven-development](../Resources-Tools/prompt-library/development/prompt-test-driven-development.md) to do RED GREEN REFACTOR. 
...
**Get consistent results**: As per the four pillars, use the combination of [AI rules](../Resources-Tools/rules-for-ai), [prompts](../Resources-Tools/prompt-library) and clear [product requirements](../generating-requirements/README.md).

**Review everything generated**: You must review and refine everything generated by the agent.

{% include page-navigation.html 
   prev_url="development" 
   prev_title="Development" 
   next_url="testing" 
   next_title="Testing" %}