...
Just as with writing source code, the generation of good unit tests requires clear requirements, rules and instructions for AI, a suitable model and good prompting. Read more about this in [the four pillars](../getting-started/the-four-pillars.md)
...
> **GitHub Copilot tip:** The [Tester agent](https://defra.github.io/ai-sdlc-tool-guidance/tool-setup/github-copilot/agents/tester){:target="_blank"} (opens in new tab) generates BDD-style tests following Defra conventions. Use it alongside the [Write Tests prompt](https://defra.github.io/ai-sdlc-tool-guidance/tool-setup/github-copilot/prompts/write-tests){:target="_blank"} (opens in new tab) for consistent test generation.
...
2. **AI rules and instructions**: Set up project [rules and instructions for AI](../appendix/rules-for-ai/) to define approach and patterns for writing journey tests
...
> **GitHub Copilot tip:** The [Tester agent](https://defra.github.io/ai-sdlc-tool-guidance/tool-setup/github-copilot/agents/tester){:target="_blank"} (opens in new tab) includes Playwright journey test patterns with GDS component selectors and axe-core accessibility checks.
