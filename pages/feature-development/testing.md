...
2. **AI rules**: Set up project [Rules for AI](../Resources-Tools/rules-for-ai/) to define apporach and patterns for writing journey tests
...
- Use [prompt-add-journey-test](../Resources-Tools/prompt-library/testing/prompt-add-journey-test.md) and reference your requirements files directly with the Coding Assistant Agent
